	...
	return {
		...
		resizeBindings: function() {
			...
			//if($(".dashboard-imagens").width()){
				var wdash = $(window).width() -($(window).width()*0.2);
				...
				onSlideBefore: function($slideElement, oldIndex, newIndex) {
					...
					//console.log("newProject: "+newProject)
							...
							if(!rb.main.isMobile){
								...
								}else if(newProject == "datafarma4" || newProject == "datafarma6" || newProject == "dashboard" ){
								...
								$(".pager").mouseout(function() {
									if(newProject == "datafarma4" || newProject == "datafarma6" || newProject == "dashboard"){
